...
<div class="flex min-h-screen w-full bg-slate-50">
	...
	<aside class="hidden w-64 flex-col border-r border-slate-200 bg-white md:flex">
		<div class="flex h-14 items-center border-b border-slate-200 px-6">
			<span class="text-lg font-bold text-slate-900">Lavans CMS</span>
		</div>
	...
	<div class="flex flex-1 flex-col">
		<header class="flex h-14 items-center gap-4 border-b border-slate-200 bg-white px-6">
			...
			<div class="flex flex-1 items-center justify-end gap-4">
				...
				<button
					onclick={logout}
					class="text-sm font-medium text-slate-500 hover:text-slate-900 cursor-pointer"
				>
					Logout
				</button>
			</div>
